      ...
      <div class="w-full mt-12 rounded-lg p-3 lg:p-12 bg-white">
        <div class="flex flex-col xl:flex-row">
          <div class="flex-shrink-0 xl:pr-10 lg:block w-full mx-auto md:w-6/12 lg:w-5/12 xl:w-4/12">
            ...
            <ImageGallery className="h-96" showNav={false} autoPlay={true} showPlayButton={false} items={product.images} />
            </div>
          </div>
          <div class="w-full">
              ...
              <div class=" w-full  xl:pr-6 md:pr-6 md:w-2/3 mob-w-full">
               ...
               <div class="mb-6">
                  ...
                  <p class="uppercase  font-medium text-gray-500 text-sm">
                    SKU : <span class="font-bold text-gray-600">{product.SKU}</span>
                  </p>
                  <div class="relative">
                ...
                <div class="mb-4"></div>
                <div>
                  <div class="text-sm leading-6 text-gray-500 md:leading-7">{product.description}
                    <br />
                  ...
                  <div class="flex items-center mt-4">
                    <div class="flex items-center  space-s-3 sm:space-s-4 w-full">
                      <div class="group flex items-center justify-between rounded-md overflow-hidden flex-shrink-0 border h-11 md:h-12 border-gray-300">
                        ...
                        <button class="flex items-center justify-center h-full flex-shrink-0 transition ease-in-out duration-300 focus:outline-none w-8 md:w-12 text-heading border-s border-gray-300 hover:text-gray-500">
                          <span class="text-dark text-base">
                            <svg
                              stroke="currentColor"
                              fill="none"
                  ...
                  <div class="flex flex-col mt-4">
                    <span class=" font-semibold py-1 text-sm d-block">
                     ...
                     {
                      product.categories.map((category,i)=> <button key={i}
                        type="button"
                    ...
                    <div class="flex flex-row">
                      {
                        product.tags.map((tag,i)=><span key={i} class="bg-gray-50 mr-2 border-0 text-gray-600 rounded-full inline-flex items-center justify-center px-3 py-1 text-xs font-semibold  mt-2">
                        {tag.label}
                      </span>)
                      }
                    </div>
