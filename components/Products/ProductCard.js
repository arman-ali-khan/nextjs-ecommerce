...
const ProductCard = ({items}) => {
    return (
        <div>
            ...
            <div className='flex cursor-pointer select-none justify-between items-center mx-3 bg-gray-100 duration-300 border border-teal-600 text-black  pl-4 hover:bg-teal-600 rounded hover:text-white'>
                    <button>Add</button>
