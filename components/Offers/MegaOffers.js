...
const MegaOffers = () => {
  return (
    <div class="container mx-auto">
      ...
      <div class="mx-auto max-w-screen-2xl px-4 py-5 sm:px-10">
        <div class="grid gap-6 grid-cols-1 xl:grid-cols-2">
          <div class="coupon block md:flex lg:flex md:justify-between lg:justify-between items-center bg-white rounded-md shadow-sm">
            <div class="tengah p-6 flex items-center justify-items-start">
              <figure>
            ...
            <div class="md:border-l-2 lg:border-l-2 border-dashed lg:w-1/3 md:w-1/3 relative px-6">
            ...
            <div class="md:border-l-2 lg:border-l-2 border-dashed lg:w-1/3 md:w-1/3 relative px-6">
              <div class="info flex lg:my-6 md:my-5 mb-6 items-center">
                <div class="w-full">
                  ...
                  <p class="text-xs leading-5 text-gray-500 mt-2">
                    * This coupon code will apply on when you shopping more then{" "}
                    <span class="font-bold text-gray-700">$1000</span>{" "}
                  </p>
                </div>
              </div>
            </div>
