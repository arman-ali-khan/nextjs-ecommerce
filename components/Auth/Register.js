    ...
    return (
        ...
        <div className="flex justify-center items-center h-full gap-2">
          ...
          <div className='flex justify-between'>
            <span onClick={()=>setLogin(!login)} className={`px-4 py-2 cursor-pointer select-none rounded-l bg_primary border border_primary  text-white w-full`}>Login</span>
            <span className={`px-4 py-2  rounded-r text-black border border_primary w-full`}>Register</span>
        </div>
            ...
            <div>
            <button className="px-4 py-2 duration-300 bg_primary hover:bg-teal-700 rounded text-white w-full">Create Account</button>
          </div>
          </div>
