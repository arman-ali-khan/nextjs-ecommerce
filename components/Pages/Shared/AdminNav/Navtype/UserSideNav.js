    ...
    return (
        <div className='h-full bg-base-100 border-r'>
            <div className='grid md:hidden grid-cols-2 bg-base-100'>
                <button onClick={()=>setShowMenu(false)} className={`py-2  border-teal-600 w-full border-b border-r ${showMenu || 'bg-teal-600 text-white'} flex items-center gap-2 px-2`}> <span><BiCategory size={20} /></span> User</button>
