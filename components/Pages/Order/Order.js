...
const orderData = {
 ...
 <div className="pt-4 space-y-2">
     ...
     <div className="space-y-6">
         ...
         <button disabled={location.length<3 } type="submit" className="w-full py-2 font-semibold border rounded bg-teal-600 text-gray-50 disabled:bg-slate-400 border-teal-600">{loading ? 'Order making...':'Go to checkout'}</button>
     </div>
 </div>
</div>
        </form>
